...
public class ProzorZaUnosPodatakaZaZavrsenuVoznjuPutemAplikacije extends JFrame {
    ...
    private NarucivanjeVoznjePrekoAplikacije nadjiVoznju;

    public ProzorZaUnosPodatakaZaZavrsenuVoznjuPutemAplikacije(Liste ucitavanje, NarucivanjeVoznjePrekoAplikacije nadjiVoznju){
