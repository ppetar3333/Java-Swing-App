...
public class ProzorZaIzmenuVoznjiPutemTelefona extends JFrame {
    ...
    public ProzorZaIzmenuVoznjiPutemTelefona(Liste ucitavanje, NarucivanjeVoznjePrekoTelefona voznja){
