...
public class IstorijaVoznjeVozacTelefon extends JFrame {
    ...
    private void initGUI(){
        ...
        Object[][] sadrzaj = new Object[ucitavanje.prikazVoznjeZaIstorijuVoznjePrekoTelefona().size()][zaglavnje.length];
        int j = 0;
        for(int i = 0; i < ucitavanje.prikazVoznjeZaIstorijuVoznjePrekoTelefona().size(); i++){
            NarucivanjeVoznjePrekoTelefona voznje = ucitavanje.prikazVoznjeZaIstorijuVoznjePrekoTelefona().get(i);
